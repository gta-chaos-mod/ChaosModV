...
namespace Memory
{
	inline std::vector<Hash> GetAllPedModels()
	{
		...
		if (c_rgPedModels.empty())
		{
			...
			handle = FindPattern("48 8B 05 ? ? ? ? 4C 8B 14 D0 EB 09 41 3B 0A 74 54 4D 8B 52 08 4D 85 D2 75 F2 4D 8B "
			...
			handle = FindPattern("0F B7 05 ? ? ? ? 45 33 C9 4C 8B DA 66 85 C0 0F 84 ? ? ? ? 44 0F B7 C0 33 D2 8B C1 41 "
			...
			handle = FindPattern("4C 0F AF 05 ? ? ? ? 4C 03 05 ? ? ? ? EB 09 49 83 C2 04 EB B2 4D 8B C1 4D 85 C0 74 03 "
			...
			handle = FindPattern("3B 05 ? ? ? ? 7D 35 4C 8B C0 83 E0 1F 8B D0 48 8B 05 ? ? ? ? 49 8B C8 48 C1 E9 05 8B "
