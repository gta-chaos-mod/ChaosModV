...
static void OnStart()
{
	Vector3 pos2 = GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER_PED_ID(), 0, 1, 0);
	Vector3 pos1 = GET_ENTITY_COORDS(PLAYER_PED_ID(), 1);
	
	SHOOT_SINGLE_BULLET_BETWEEN_COORDS(pos1.x, pos1.y, pos1.z, pos2.x, pos2.y, pos2.z, 0, 0, 0x3656C8C1, PLAYER_PED_ID(), 1, 0, 100);
