...
{
public:
	EffectInfo(const char* name, const char* id, bool isTimed = false, std::vector<EffectType> incompatibleList = {}, bool shortDur = false, EffectExecutionType type = EffectExecutionType::DEFAULT, const char* fakeName = "")
		: Name(name), Id(id), IsTimed(isTimed), IsShortDuration(shortDur), IncompatibleWith(incompatibleList), ExecutionType(type), FakeName(fakeName) {}
...
const std::unordered_map<EffectType, EffectInfo> g_effectsMap =
{
	...
	{EFFECT_FAKE_PLAYER_SWAP, {"Player Swap", "player_playerswap", true, {}, true, EffectExecutionType::DEFAULT, "Player Swap"}},
	...
	{EFFECT_PLAYER_FAKEDEATH, {"Fake Death", "player_fakedeath", false, {}, false, EffectExecutionType::DEFAULT, "Suicide"}},
