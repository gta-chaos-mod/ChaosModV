...
const std::map<EffectType, EffectInfo> g_effectsMap =
{
	...
	{EFFECT_MINUS_100K, {"Poor Boy", "poorboi"}},
	...
	{EFFECT_PLAYER_PORTAL_GUN, {"Portal Gun", "player_portal_gun", true}},
	...
	{EFFECT_PEDS_INTORANDOMVEHS, {"Set All Peds Into Random Vehicles", "peds_intorandomvehs"}},
};
