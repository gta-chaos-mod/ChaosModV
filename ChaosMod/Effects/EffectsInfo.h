...
const std::map<EffectType, EffectInfo> g_effectsMap =
{
	...
	{EFFECT_LOW_GRAV, {"Low Gravity", "lowgravity", true, { EFFECT_VERY_LOW_GRAV, EFFECT_INSANE_GRAV, EFFECT_INVERT_GRAV }}},
	{EFFECT_VERY_LOW_GRAV, {"Very Low Gravity", "verylowgravity", true, { EFFECT_LOW_GRAV, EFFECT_INSANE_GRAV, EFFECT_INVERT_GRAV }}},
