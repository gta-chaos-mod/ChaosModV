...
static void OnTick()
{
	...
	if (current_time - last_firework > 500)
	{
		...
		int x = pos.x + Random::GetRandomInt(-220, 220);
		int y = pos.y + Random::GetRandomInt(-220, 220);
		int z = pos.z + Random::GetRandomInt(50, 150);
		START_PARTICLE_FX_NON_LOOPED_AT_COORD(Random::GetRandomInt(0, 1) == 0 ? "scr_firework_indep_ring_burst_rwb" : "scr_firework_indep_spiral_burst_rwb", x, y, z, 0.0f, 0.0f, 0.0f, 2.0f, true, true, true);
