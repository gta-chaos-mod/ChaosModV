...
static void OnStart()
{
	static constexpr Hash modelHash = -2113195075;
	...
	ADD_RELATIONSHIP_GROUP("_HOSTILE_DENISE", &relationshipGroup);
...
static RegisterEffect registerEffect(EFFECT_ANGRY_DENISE, OnStart, EffectInfo
	{
		.Name = "Spawn Displeased Denise",
		.Id = "peds_displeasedenise",
