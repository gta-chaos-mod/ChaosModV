...
static void OnStart()
{
	static constexpr Hash modelHash = 0x15CD4C33;
	...
	ADD_RELATIONSHIP_GROUP("_HOSTILE_DAV", &relationshipGroup);
...
static RegisterEffect registerEffect(EFFECT_SPAWN_DAVE, OnStart, EffectInfo
	{
