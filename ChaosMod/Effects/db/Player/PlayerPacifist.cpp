...
static void OnTick()
{
	...
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_COMPACTLAUNCHER"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_GRENADELAUNCHER"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_PIPEBOMB"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_PROXMINE"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_RPG"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_SMOKEGRENADE"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_STICKYBOMB"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_HOMINGLAUNCHER"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_MOLOTOV"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_GRENADE"));
	REMOVE_WEAPON_FROM_PED(playerPed, GET_HASH_KEY("WEAPON_RAILGUN"));
}
