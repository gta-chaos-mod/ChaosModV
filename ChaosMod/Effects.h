...
const std::map<EffectType, EffectInfo> g_effectsMap =
{
	...
	{EFFECT_SCREEN_BLOOM, {"Bloom", "screen_bloom", true, { EFFECT_SCREEN_LSD, EFFECT_SCREEN_RENDERDIST, EFFECT_SCREEN_FOG, EFFECT_SCREEN_BRIGHT }}},
	{EFFECT_SCREEN_LSD, {"LSD", "screen_lsd", true, { EFFECT_SCREEN_BLOOM, EFFECT_SCREEN_RENDERDIST, EFFECT_SCREEN_FOG, EFFECT_SCREEN_BRIGHT }}},
	{EFFECT_SCREEN_REALLSD, {"Actual LSD", "screen_lsd2", true}},
	{EFFECT_SCREEN_CHOPVISION, {"Chop Vision", "screen_chop", true}},
	{EFFECT_SCREEN_RENDERDIST, {"Where Did Everything Go?", "screen_lowrenderdist", true, { EFFECT_SCREEN_LSD, EFFECT_SCREEN_BLOOM, EFFECT_SCREEN_FOG, EFFECT_SCREEN_BRIGHT }, true}},
	{EFFECT_SCREEN_FOG, {"Extreme Fog", "screen_fog", true, { EFFECT_SCREEN_LSD, EFFECT_SCREEN_BLOOM, EFFECT_SCREEN_RENDERDIST, EFFECT_SCREEN_BRIGHT }, true}},
	{EFFECT_SCREEN_BRIGHT, {"Deep Fried", "screen_bright", true, { EFFECT_SCREEN_LSD, EFFECT_SCREEN_BLOOM, EFFECT_SCREEN_RENDERDIST, EFFECT_SCREEN_FOG }}},
