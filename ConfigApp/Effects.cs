...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_PLAYER_EASY_AIM, new EffectInfo("Bullet Time", EffectCategory.PLAYER, "player_easy_aim", true)},
            ...
            {EffectType.EFFECT_PEDS_INTERVENTION,  new EffectInfo("Divine Intervention", EffectCategory.PEDS, "peds_intervention")},
        };
    }
}
