...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_VEHS_TINY,
            EFFECT_PLAYER_PLAY_RANDOM_CUTSCENE,
            _EFFECT_ENUM_MAX
        }
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_PLAYER_PLAY_RANDOM_CUTSCENE, new EffectInfo("Play Random Cutscene", EffectCategory.PLAYER, "player_play_random_cutscene")},
        };
    }
}
