...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_NO_SPRINT_JUMP, new EffectInfo("No Sprint & Jump", EffectCategory.PLAYER, "player_nosprint", true)},
            ...
            {EffectType.EFFECT_PEDS_CAT_GUNS, new EffectInfo("Cat Guns", EffectCategory.PEDS, "peds_catguns", true)},
        };
    }
}
