...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_PLAYER_WARPED_CONTROL_STICK,
            _EFFECT_ENUM_MAX
        }
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_PLAYER_WARPED_CONTROL_STICK, new EffectInfo("Controller Experience", EffectCategory.PLAYER, "player_warped_control_stick", true, true)},
        };
    }
}
