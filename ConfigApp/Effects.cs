...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_PLAYER_INVERT_VEH_CONTROLS,
            _EFFECT_ENUM_MAX
        }
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_PLAYER_INVERT_VEH_CONTROLS, new EffectInfo("Invert Vehicle Controls", EffectCategory.PLAYER, "player_invert_veh_controls", true, true)},
        };
    }
}
