...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_GIVE_TAZER, new EffectInfo("Give Stun Gun", EffectCategory.PLAYER, "player_givestungun")},
            ...
            {EffectType.EFFECT_GIVE_BATTLEAXE, new EffectInfo("Give Battle Axe", EffectCategory.PLAYER, "player_givebattleaxe")},
            ...
            {EffectType.EFFECT_ONE_BULLET_WEP, new EffectInfo("One Bullet Mags", EffectCategory.MISC, "misc_onebullet", true)},
