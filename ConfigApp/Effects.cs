...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
	        ...
	        {EffectType.EFFECT_PLAYER_LAUNCH, new EffectInfo("Launch Player Up In The Air", EffectCategory.PLAYER, 17)},
	        {EffectType.EFFECT_PLAYER_VEH_LAUNCH, new EffectInfo("Launch Current Vehicle Up In The Air", EffectCategory.VEHICLE, 18)},
