...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_VEHS_TINY,
            EFFECT_PLAYER_DISABLE_RANDOM_HUD,
            _EFFECT_ENUM_MAX
        }
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectInfo.EFFECT_PLAYER_DISABLE_RANDOM_HUD, new EffectInfo("Disable Random Hud Component", EffectCategory.PLAYER, "player_random_hud", true)}
        };
    }
}
