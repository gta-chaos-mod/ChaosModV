...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public enum EffectType
        {
            ...
            EFFECT_VEHS_DISAPPEAR_ON_IMPACT,
            _EFFECT_ENUM_MAX
        }
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_VEHS_DISAPPEAR_ON_IMPACT, new EffectInfo("Vehicles Disappear On Impact", EffectCategory.VEHICLE, "vehs_disappear_on_impact", true)},
        };
    }
}
