...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_EXPLODE_CUR_VEH_FAKE, new EffectInfo("Fake Detonate Current Vehicle", EffectCategory.VEHICLE, "playerveh_fake_explode")},
